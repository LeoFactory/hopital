...
- un interface invité qui permet de visulaiser des informations générales sur l'hôpital tel que le nombre de médecins, d'infirmiers ...
le pourcentage de patients atteint par pathologies, le nombre de chambre , le nombre de places occupé , le pourcentage total d'occupation des lits par les patients...
